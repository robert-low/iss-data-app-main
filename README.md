...
- `position.rb`
  - I amended this existing page to display the position of the ISS. I needed to consider that this data was stored in a value with a hash as its data type e.g " { iss_position": { "longitude": "-3.4941", "latitude": "-37.5113" } }.
  - I thought formatting the date and time generated by Time.at using #strftime would make sense for readability.
  - I added in a button link to return home using the predefined route **/** to the index page, for ease. I did the same to link to the JSON data.
- `app.rb`
  - I added an extra route to **/astros**, which makes a GET request that uses the OpenNotify#astros method, and displays the data in astros.html.erb.
...
- `layout.html.erb`
  - My stylesheet for the app and Google Fonts are imported here.
- `public/stylesheets/application.css`
  - All CSS components and styling is added here. Images can be found in `public/images`.
